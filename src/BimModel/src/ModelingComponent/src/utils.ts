...
export const CategoryTool: Record<ICategory, {[drawType: string]: IModeling}> =
  {
    ...
    Door: {Point},
    Window: {Point},
    "Structure Beam": {Line, Rectangular, Arc, PickLine},
...
export function getModelings(type: string): {[drawType: string]: IModeling} {
