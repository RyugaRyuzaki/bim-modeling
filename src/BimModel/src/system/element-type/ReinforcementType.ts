...
import {Handle, IFC4, IFCREINFORCINGBARTYPE} from "web-ifc";
...
export class ReinforcementType
  ...
  implements IFC4.IfcReinforcingBarType
{
  ...
  PredefinedType!: IFC4.IfcReinforcingBarTypeEnum;
  NominalDiameter!: IFC4.IfcPositiveLengthMeasure | null;
  CrossSectionArea!: IFC4.IfcAreaMeasure | null;
  BarLength!: IFC4.IfcPositiveLengthMeasure | null;
  BarSurface!: IFC4.IfcReinforcingBarSurfaceEnum | null;
  BendingShapeCode!: IFC4.IfcLabel | null;
  BendingParameters!: IFC4.IfcBendingParameterSelect[] | null;
  type = IFCREINFORCINGBARTYPE;
  ReferencedBy!:
  ...
  HasAssociations!:
    ...
    | null;
  expressID!: number;
  typeName = IfcElements[IFCREINFORCINGBARTYPE];
  typeEnum: IElementTypeEnum = "ReinforcementType";
  /**
   *
   */
