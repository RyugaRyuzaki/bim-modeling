...
import {Handle, IFC4, IFCCOILTYPE} from "web-ifc";
import {BaseElementType} from "./BaseElementType";
import {IElementTypeEnum} from "./types";
import {IfcElements} from "../base";

export class ColumnType extends BaseElementType implements IFC4.IfcBeamType {
  ...
  HasAssociations!:
    ...
    | null;
  expressID!: number;
  typeName = IfcElements[IFCCOILTYPE];
  typeEnum: IElementTypeEnum = "ColumnType";
  /**
   *
   */
