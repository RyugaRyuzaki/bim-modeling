...
import {Handle, IFC4, IFCWALLTYPE} from "web-ifc";
import {IElementTypeEnum} from "./types";
import {BaseElementType} from "./BaseElementType";
import {IfcElements} from "../base";

export class WallType extends BaseElementType implements IFC4.IfcWallType {
  ...
  PredefinedType!: IFC4.IfcWallTypeEnum;
  type = IFCWALLTYPE;
  ReferencedBy!:
  ...
  HasAssociations!:
    ...
    | null;
  expressID!: number;
  typeName = IfcElements[IFCWALLTYPE];
  typeEnum: IElementTypeEnum = "WallType";
  /**
   *
   */
